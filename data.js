...
const T = {
  zh: {
    ...
    detail_booking:   "📞 预约方式",
    exchange_calc:    "💱 韩元汇率换算",
    exchange_rate:    "1 KRW ≈",
    exchange_to_cny:  "输入韩元金额",
    exchange_result:  "换算结果",
  ...
  en: {
    ...
    exchange_calc:    "💱 KRW to USD Converter",
    exchange_rate:    "1 KRW ≈",
    exchange_to_usd:  "Enter KRW amount",
    exchange_result:  "Converted",
  ...
  ja: {
    ...
    detail_booking:   "📞 予約方法",
    exchange_calc:    "💱 KRW → JPY 変換",
    exchange_rate:    "1 KRW ≈",
    exchange_to_jpy:  "韓国ウォン金額",
    exchange_result:  "換算結果",
    home_title:    "insight-medi",
