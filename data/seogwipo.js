  ...
  "bellemorn": {
    ...
    review_summary: {
      zh: {
        ...
        highlights: ["院长亲自诊断施术", "私密单人护理室", "公假正常营业", "神话世界免费停车", "非流水线体验"],
        platforms: {
          naver: {
            ...
            keywords: ["院长直接诊察", "细致说明", "Thermage", "提拉", "Rejuran", "私密", "满意", "预约"],
            pros: ["院长全程亲自诊察施术，非助手代劳", "每次有个人专属护理室，私密性高", "周六及公假正常营业，旅游途中可安排", "神话世界内部停车免费且方便", "院长15年以上经验，提拉手术技术稳定"],
            cons: ["位于西归浦神话世界，从济州市区需约50~60分钟", "100%预约制，当天突然来访无法接诊", "月/日固定休息，需提前确认", "价格相比市区略高"],
            cautions: ["Thermage、Ulthera等提拉项目效果因年龄和皮肤状态存在较大个体差异", "提拉效果一般需要1~3个月逐渐显现，不适合对即时效果有强烈期待的情况", "价格因施术组合不同差异较大，建议先咨询确认", "从济州市区前往需预留充足时间"]
          },
          google: {
            source: "Google Maps", count_hint: "约 40 条",
            summary: "Google评论整体评分偏高（平均4.6星），简短评价中多出现「professional」「great experience」「worth the trip」等正面词汇。有外国旅客留下英文评论，说明接待外国患者有一定经验，特别提到「private room」「personal attention」等亮点。",
            keywords: ["professional", "满意", "友善", "神话世界", "private room", "personal attention", "worth the trip"],
            pros: ["外国患者评论说明有接诊外国人的经验", "整体评分偏高（4.6星），口碑方向正面", "私密单人护理室获得好评", "院长亲自施术获得信任", "位于神话世界，旅游+美容可结合"],
            cons: ["英文评论较少细节，难以做深入判断", "距离济州市区较远"],
            cautions: ["Google评论细节不足，建议搭配Naver评论综合阅读", "外国患者需提前确认语言沟通方式"]
          },
          daum: {
            source: "Kakao Map", count_hint: "约 20 条",
            summary: "Kakao Map评论数量较少，出现「神话世界停车方便」「预约顺畅」「环境高端」等实用信息。可作为核实交通和预约体验的参考来源。",
            keywords: ["停车", "预约", "位置", "环境", "高端"],
            pros: ["停车便利性有多条评论印证", "诊所环境高端", "预约流程顺畅"],
            cons: ["样本量少，整体代表性有限", "评论细节不足"],
