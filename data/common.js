...
const T = {
  zh: {
    tab_home: "首页", tab_hospitals: "医院", tab_contents: "攻略", tab_me: "我的", tab_booking: "医院信息", tab_map: "地图",
    home_title: "因赛特美医", home_subtitle: "皮肤科 · 整形外科公开信息",
    home_pick: "医院信息", home_latest: "最新攻略", home_more: "查看更多 →",
    ...
    detail_contact: "医院联系信息", detail_map: "地图导航", detail_naver: "Naver 地图",
    detail_google: "Google 地图", detail_kakao: "Kakao 地图",
    modal_wechat_title: "微信联系方式", modal_wechat_id: "微信号",
    modal_wechat_copy: "复制微信号", modal_wechat_note: "请复制微信号后自行添加该医院账号联系",
    modal_wechat_copied: "已复制！",
    modal_line_title: "LINE 联系方式", modal_line_id: "LINE ID",
    modal_line_copy: "复制 LINE ID", modal_line_note: "请复制 LINE ID 后自行添加该医院账号联系",
    modal_line_copied: "已复制！",
    modal_ig_title: "Instagram 联系方式", modal_ig_handle: "Instagram",
    modal_ig_copy: "复制帐号", modal_ig_note: "请自行搜索并直接与医院联系",
    modal_ig_copied: "已复制！",
    modal_close: "关闭", modal_wechat_btn: "查看微信号", modal_line_btn: "查看 LINE ID",
    ...
    spec_open_now: "立即就诊", spec_foreign_official: "外国患者就诊许可",
    badge_licensed_label: "外国患者就诊许可医院",
    badge_licensed_tooltip: "该医院已根据韩国相关法律在保健福祉部登记为外国患者就诊许可医疗机构。本标识仅表示登记事实，不代表本平台对该医院进行评价或推荐。",
    spec_derm_cert: "皮肤科专科",
    spec_oriental: "韩医院", spec_other: "其他医院",
    detail_payment: "💳 结账方式", detail_languages: "🗣️ 语言服务",
    detail_doctor: "👨‍⚕️ 医生信息", detail_booking: "📞 联系方式",
  ...
  en: {
    ...
    tab_me: "My", tab_booking: "Info", tab_map: "Map",
    home_title: "insight-medi", home_subtitle: "Dermatology & Aesthetic Clinics",
    home_pick: "Clinic Information", home_latest: "Latest Articles", home_more: "See More →",
    ...
    detail_contact: "Clinic Contact Info", detail_map: "Map", detail_naver: "Naver Map",
    detail_google: "Google Maps", detail_kakao: "Kakao Map",
    modal_wechat_title: "WeChat Inquiry", modal_wechat_id: "WeChat ID",
    modal_wechat_copy: "Copy WeChat ID", modal_wechat_note: "Use this channel to contact the clinic directly",
    modal_wechat_copied: "Copied!",
    modal_line_title: "LINE Inquiry", modal_line_id: "LINE ID",
    modal_line_copy: "Copy LINE ID", modal_line_note: "Use this channel to contact the clinic directly",
    modal_line_copied: "Copied!",
    modal_ig_title: "Instagram DM", modal_ig_handle: "Instagram",
    modal_ig_copy: "Copy Handle", modal_ig_note: "Use Instagram to contact the clinic directly",
    ...
    spec_open_now: "Open Now", spec_foreign_official: "Gov't Registered",
    badge_licensed_label: "Gov't Registered (Foreign Patients)",
    badge_licensed_tooltip: "This clinic is officially registered with Korea's Ministry of Health and Welfare as a licensed medical institution for foreign patients. This badge indicates registration status only and does not represent an endorsement or quality assessment by this platform.",
    ...
    detail_doctor: "👨‍⚕️ Doctor Info", detail_booking: "📞 Contact Method",
  ...
  ja: {
    ...
    tab_me: "マイページ", tab_booking: "情報", tab_map: "マップ",
    home_title: "insight-medi", home_subtitle: "皮膚科・整形外科 公開情報",
    home_pick: "クリニック情報", home_latest: "最新記事", home_more: "もっと見る →",
    ...
    detail_contact: "クリニック連絡先情報", detail_map: "地図", detail_naver: "Naver マップ",
    detail_google: "Google マップ", detail_kakao: "Kakao マップ",
    modal_wechat_title: "WeChat 連絡先情報", modal_wechat_id: "WeChat ID",
    modal_wechat_copy: "WeChat ID をコピー", modal_wechat_note: "コピー後、ご自身で医院に直接ご連絡ください",
    modal_wechat_copied: "コピーしました！",
    modal_line_title: "LINE 連絡先情報", modal_line_id: "LINE ID",
    modal_line_copy: "LINE ID をコピー", modal_line_note: "コピー後、ご自身で医院に直接ご連絡ください",
    modal_line_copied: "コピーしました！",
    modal_ig_title: "Instagram DM", modal_ig_handle: "Instagram",
    modal_ig_copy: "アカウントをコピー", modal_ig_note: "Instagramで医院に直接ご連絡ください",
    ...
    spec_open_now: "今すぐ診療", spec_foreign_official: "外国人患者受入許可",
    badge_licensed_label: "外国人患者受入許可医療機関",
    badge_licensed_tooltip: "本クリニックは、韓国の関連法に基づき保健福祉部に外国人患者受入許可医療機関として登録されています。このバッジは登録の事実のみを示すものであり、本プラットフォームによる評価・推薦を意味するものではありません。",
    spec_derm_cert: "皮膚科専門医",
    spec_oriental: "漢方医院", spec_other: "その他医院",
    detail_payment: "💳 決済方法", detail_languages: "🗣️ 言語対応",
    detail_doctor: "👨‍⚕️ 医師情報", detail_booking: "📞 連絡方法",
...
const CONTENTS_DB = [
  {
    ...
    excerpt: {
      ...
      en: "5 essential checks before choosing a clinic in Jeju — credentials, devices, reviews, and more.",
    ...
    body: {
      ...
      en: `<h2>① Verify Doctor Credentials</h2><p>Board-certified dermatologists and plastic surgeons hold official specialist licences in Korea.</p><h2>② Check Treatment Devices</h2><p>Genuine Thermage FLX and Ulthera units have unique serial numbers.</p><h2>③ Cross-reference Multiple Review Platforms</h2><p>Naver reviews are detailed, Google gives quick impressions, Kakao Map confirms location.</p><h2>④ Confirm Who Performs Procedures</h2><p>Some clinics may delegate parts of a procedure. Clarify this directly with the clinic.</p><h2>⑤ Check Availability Early</h2><p>During peak seasons, clinic schedules can fill up 2–3 weeks ahead.</p>`,
  ...
  },
  {
    ...
    excerpt: {
      ...
      en: "Lifting results take 1–3 months to appear. Here's what travellers should check before treatment.",
  ...
  },
  {
    ...
    body: {
      zh: `<h2>Naver 地图 — 适合深入研究</h2><p>评论数量最多，以长文记录为主，详细描述就诊经过。</p><h2>Google Maps — 适合快速判断</h2><p>评论较简短，评分直观，适合快速了解总体口碑走向。</p><h2>Kakao Map — 适合核实基础信息</h2><p>评论数量较少，但有时出现更具体的情境描述。</p><h2>参考查询顺序</h2><p>① Google → ② Naver → ③ Kakao Map</p>`,
      en: `<h2>Naver Map — Useful for Deep Research</h2><p>The most review-heavy platform. Reviews are predominantly long-form.</p><h2>Google Maps — Useful for Quick Impressions</h2><p>Reviews are shorter and scores are immediately visible.</p><h2>Kakao Map — Useful for Verifying Basics</h2><p>Fewer reviews but sometimes includes specific situational detail.</p><h2>Suggested Research Flow</h2><p>① Google → ② Naver → ③ Kakao Map</p>`,
      ja: `<h2>Naver マップ — 詳細確認に有用</h2><p>口コミ数が最も多く、長文形式が中心。</p><h2>Google マップ — 全体把握に有用</h2><p>口コミは比較的短く、評価スコアが一目でわかります。</p><h2>Kakao Map — 基本情報の確認に有用</h2><p>口コミ数は少ないですが、実用的な状況説明が含まれることも。</p><h2>参考にしやすい確認順序</h2><p>① Google → ② Naver → ③ Kakao Map</p>`
    }
  }
];
